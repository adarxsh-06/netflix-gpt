...
const Login = () => {
  ...
  return (
    <div>
      ...
      <form className="absolute p-6 bg-black my-36 mx-auto w-3/12 left-0 right-0 text-white rounded-lg opacity-75">
        ...
        <input type="email" placeholder="Email" required className="p-2 my-4 w-full rounded-lg bg-gray-700"/>

        <input type="password" placeholder="Password" required className="p-2 my-4 w-full rounded-lg bg-gray-700"/>
